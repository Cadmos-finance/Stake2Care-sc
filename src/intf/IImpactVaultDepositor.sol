...
interface IImpactVaultDepositor {
    ...
    function depositAsset(uint256 depositAmount) external returns (uint256 sharesCreated);
    ...
    function depositToken(uint256 amount, address token, uint256 depositProportion) external returns (uint256 sharesCreated, uint256 assetReturned);
    ...
    function depositETH(uint256 depositProportion) external payable returns (uint256 sharesCreated, uint256 assetReturned);
